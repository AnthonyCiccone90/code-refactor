# code-refactor
This is the fist graded submission. In this challenge I was assigned to refactoring the code for a client so it is more efficent to use. Below are screenshots on how the page will look when it loads. 
